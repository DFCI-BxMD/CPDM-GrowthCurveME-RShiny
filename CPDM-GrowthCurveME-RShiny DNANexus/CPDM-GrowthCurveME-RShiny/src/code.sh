...
# start rshiny ...
 ...
 url=https://raw.githubusercontent.com/DFCI-CPDM/CPDM_GrowthCurveME_RShiny/refs/heads/main/Rizky%20Version/Webapp_source
 wget -P "${vm_output}" $url/DESCRIPTION $url/server.R $url/ui.R
