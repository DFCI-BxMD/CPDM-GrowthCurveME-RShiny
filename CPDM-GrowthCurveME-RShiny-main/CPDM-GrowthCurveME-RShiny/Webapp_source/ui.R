shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("model_function", "Model Function:",
      ...
      tabsetPanel(
        tabPanel(
          ...
          p(
            style = "font-size: 16px;",
            HTML(
              "This Growth Curve application performs growth curve analysis using the dataset. ",
              "GrowthCurveME utilizes convenient wrapper functions for the saemix package to fit mixed-effects models, derive key growth metrics and model statistics, perform model diagnostics, and generate plots and tables for reporting your data. ",
          ...
          tags$ol(
            ...
            tags$ul(
              tags$li(style = "font-size: 14px;", tags$b("Model Function:"), " Choose the model to fit your data. Options include 'exponential', 'linear', 'logistic', and 'gompertz'."),
              tags$li(style = "font-size: 14px;", tags$b("Model Type:"), " Select 'mixed' for mixed-effects models or 'least-squares' for least-squares fitting."),
            ...
            tags$ul(
              tags$li(style = "font-size: 14px;", tags$b("Summary Table of Model:"), " View a summary table generated by the growth_model_summary_table() function."),
          ...
          plotOutput("InstructionsPlot")
        ),
        
        tabPanel("Summary Table of Model",
                 fluidRow(
        ...
        tabPanel("Growth Plots", 
                 p(
                   #tags$li(style = "font-size: 14px;", tags$b("Growth Metric Name:"), "  The name of the growth metric (default: growth_metric)"),
                   #tags$li(style = "font-size: 14px;", tags$b("Growth Metric Units:"), " The name of the growth metric units (default: growth_unit)"),
                 ),
                 fluidRow(
                   column(4, selectInput("plot_type", "Select Plot Type:",
                   ...
                   column(4, textInput("growth_metric_name", "Growth Metric Units:", value = "growth_metric")),
                   column(4, textInput("cluster_name", "Cluster Name:", value = "cluster"))
                 ),
                 fluidRow(
